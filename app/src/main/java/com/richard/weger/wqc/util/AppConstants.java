...
public class AppConstants {
    ...
    public final static int PROJECT_EDIT_SCREEN_KEY = 10;
    ...
    public final static int CHECK_REPORT_EDIT_SCREEN_KEY = 14;
    ...
    public final static String REST_PDFREPORTREQUEST_KEY = "httpPdfReportRequestKey";
    ...
    public final static String REST_FIRSTCONNECTIONTEST_KEY = "httpFirstConnectionKey";
    public final static String REST_ASKAUTHORIZATION_KEY = "httpAskAuthorizationKey";
    public final static String REST_REPORTITEMSSAVE_KEY = "httpReportItemSaveKey";
    public final static String JSON_PROJECT_KEY = "jsonProjectKey";
    public final static String GET_METHOD = "getMethod";
    public final static String POST_METHOD = "postMethod";
    public final static String PUT_METHOD = "putMethod";
