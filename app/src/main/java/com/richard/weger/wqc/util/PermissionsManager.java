...
public class PermissionsManager extends ActivityCompat {
    ...
    public static boolean checkPermission(String[] permissions, Activity activity, Boolean askIfDontHave) {
        ...
        for(String s:permissions){
            if((ContextCompat.checkSelfPermission(App.getContext(), s) != PackageManager.PERMISSION_GRANTED)){
                needToAsk = true;
                break;
            }
        }
    ...
    private static void askPermission(String[] permissions, Activity activity){
