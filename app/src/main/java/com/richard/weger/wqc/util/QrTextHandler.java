...
import static com.richard.weger.wqc.util.AppConstants.DRAWING_NUMBER_KEY;
import static com.richard.weger.wqc.util.AppConstants.PART_NUMBER_KEY;
import static com.richard.weger.wqc.util.AppConstants.PROJECT_NUMBER_KEY;
...
public class QrTextHandler{
    ...
    public QrTextHandler(Context context, ParamConfigurations conf)
    {
