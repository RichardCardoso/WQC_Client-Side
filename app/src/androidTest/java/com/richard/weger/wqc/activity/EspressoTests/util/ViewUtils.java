package com.richard.weger.wqc.activity.EspressoTests.util;
...
public class ViewUtils {
    ...
    public static String getString(ActivityTestRule rule, @StringRes int resId) {
        return rule.getActivity().getResources().getString((resId));
    }
